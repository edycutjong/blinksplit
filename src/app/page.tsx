...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white overflow-hidden selection:bg-primary/30">
      ...
      <section id="how-it-works" className="py-24 px-6 border-t border-white/5 bg-black/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl bg-white/5 border border-white/10 relative overflow-hidden group hover:border-primary/50 transition-colors">
              ...
              <h3 className="text-xl font-bold mb-3">1. Snap Receipt</h3>
              <p className="text-white/60">Take a photo of your dinner receipt. No manual entry needed.</p>
            </div>
            
            <div className="p-8 rounded-3xl bg-white/5 border border-white/10 relative overflow-hidden group hover:border-accent/50 transition-colors">
              ...
              <h3 className="text-xl font-bold mb-3">2. AI Parsing</h3>
              <p className="text-white/60">Our AI instantly breaks down line items, taxes, and tips automatically.</p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-white/5 border border-white/10 relative overflow-hidden group hover:border-primary/50 transition-colors">
              ...
              <h3 className="text-xl font-bold mb-3">3. Share Blink</h3>
              <p className="text-white/60">Drop the Solana Blink URL in the group chat. They click to pay USDC directly.</p>
            </div>
          </div>
        </div>
      </section>
